...
//******************* To Edit Service Provider Details******************************
Route::put('/estate/service-provider/edit/{id}', 'ServiceProviderController@update');

//******************* To view all service providers ************************
Route::get('/estate/service-provider', 'ServiceProviderController@index');

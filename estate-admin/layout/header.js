          ...
          >
            ...
            <form method="get" class="form-inline mr-4 ml-4">
                <div class="form-group header-form d-flex align-items-center">
                    <img src="../images/search.jpeg" width="16px" height="16px" alt="Search" style="opacity: 0.5;" /><input type="text" placeholder="Search residents..." class="form-control header-input bg-white" />
                </div>
            </form>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav d-flex justify-content-between icons">
                    ...
                    <li class="nav-item">
                        <img src="../images/Person.svg" alt="You" srcset="" />
                    </li>
                    ...
                    <li class="nav-item">
                        <img src="../images/chevron-down.svg" width="14px" height="20px" alt="Down" />
                    </li>
                </ul>
            </div>
            </nav>

...
<div class="container-fluid">
    <div class="row">
        <nav class="navbar navbar-expand-lg navbar-light our-nav col-12 border-bottom">
            <a class="navbar-brand app-logo" href="<?php echo e(url('/')); ?>">
            ...
            <div class="collapse navbar-collapse nav-utilities" id="navbarSupportedContent">
                ...
                <a href="<?php echo e(url('login')); ?>"><button class="btn btn-success login-btn mx-2">LOGIN</button></a>
...
<?php /**PATH /home/tobecci/development/Gateapp-api/resources/views/layout.blade.php ENDPATH**/ ?>
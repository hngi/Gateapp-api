...
//push notifier this can be switched in the controller to notify either using user_type ->gateman or resident
Route::get('pushtest/{user_id}', 'SendPushNotificationController@testNotification');

//test rout
Route::get('notifyresident/{user_id}', 'SendPushNotificationController@sendNotification');